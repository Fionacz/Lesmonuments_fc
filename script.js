...
function showMonumentInfo(id) {
  ...
  <div class="monument-info-content">
    <h2>${monument.name}</h2>
    <p><strong class="title-ville">Ville :</strong> ${monument.city}</p>
    <p><strong class="title-pays">Pays :</strong> ${monument.country}</p>
    <p><strong class="title-histoire">Histoire :</strong> ${monument.description}</p>
